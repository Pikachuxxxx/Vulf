...
static std::vector<uint16_t> sphereIndices;
static std::vector<uint16_t> sphereQuadIndices;
...
static void GenerateSphereSmooth(int radius, int latitudes, int longitudes)
{
    ...
    /*
     *  Indices - Produces clockWise front faces
     *  k1--k1+1
     *  |  / |
     *  | /  |
     *  k2--k2+1
...
static void GenerateQuadSphere(int radius, int latitudes, int longitudes)
{
    if(longitudes < 3)
        longitudes = 3;
    if(latitudes < 2)
    ...
    /*
     *  Indices - Quad mesh faces in a clock wise fashion
     *  k1--k1+1
     *  |    |
     *  |    |
     *  k2--k2+1
