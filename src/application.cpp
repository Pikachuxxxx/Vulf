...
void Application::OnImGui()
{
    ...
    ImGui::Begin("Image Demo");
    {
        ...
        // ImGui::Image((ImTextureID)ImGui_ImplVulkan_AddTexture(depthImage.get_handle().get_sampler(), depthImage.GetDepthImageView(), VK_IMAGE_LAYOUT_DEPTH_STENCIL_ATTACHMENT_OPTIMAL), ImVec2(200, 200));
