...
void UniformBuffer::CreateUniformBuffer(uint32_t swapImagesCount, Texture& texture)
{
    m_Texture = texture;
...
void UniformBuffer::UpdateBuffer(UniformBufferObject buffer, uint32_t index)
{
    void* data;
...
void UniformBuffer::UpdateLightBuffer(LightUniformBufferObject buffer, uint32_t index)
{
    void* data;
