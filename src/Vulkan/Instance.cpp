...
void Instance::Init(std::string appname, GLFWwindow* window, bool enableValidationLayers /*= true*/)
{
...
VKAPI_ATTR VkBool32 VKAPI_CALL Instance::DebugCallback(VkDebugUtilsMessageSeverityFlagBitsEXT message_severity,
