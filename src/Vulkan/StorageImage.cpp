...
void StorageImage::Init(uint32_t width, uint32_t height)
{
    ...
    ImageTransitionInfo shaderRead(m_ImgHandle, VK_ACCESS_SHADER_READ_BIT, VK_ACCESS_SHADER_READ_BIT, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL, VK_IMAGE_LAYOUT_GENERAL);
