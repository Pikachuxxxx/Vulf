...
void DescriptorSet::CreateSets(uint32_t size, VkDescriptorPool pool, VkDescriptorSetLayout descriptorSetLayout, std::vector<Buffer> uniformBuffers, uint32_t uboSize, Texture texture)
{
